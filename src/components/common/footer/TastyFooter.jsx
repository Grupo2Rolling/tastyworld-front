        ...
        <div className="row text-center mt-2">
          ...
          >
            <a href="#" className=" redes"
              ><i className="mx-2" aria-hidden="true"><IoLogoFacebook /></i
            ></a>
            <a href="#" className=" redes"
              ><i className="mx-2" aria-hidden="true"><AiOutlineInstagram /></i
            ></a>
            <a href="#" className=" redes"
              ><i className="mx-2" aria-hidden="true"><AiFillTwitterCircle /></i
            ></a>
          </div>
          <div
            className="col-12 col-md-4 mb-4 mb-md-2 d-flex align-items-center justify-content-center"
